    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 mb-6">
      <div class="card">
        ...
        <div class="card-content">
          <form action="function/upload_photo.php" method="POST" enctype="multipart/form-data">
            <div class="field">
              ...
              <div class="field-body">
                <div class="field file">
                  <label class=" ">
                    ...
                    <input class="button blue" type="file" name="photo" accept="image/*" required>
                  </label>
                </div>
              </div>
            </div>
            ...
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                    <input type="text" autocomplete="on" name="name" value="<?php echo $data['name'];?>" class="input" required>
                  </div>
            ...
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                    <input type="email" autocomplete="on" name="email" value="<?php echo $data['email'];?>" class="input" required>
                  </div>
